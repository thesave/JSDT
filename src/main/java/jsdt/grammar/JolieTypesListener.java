...
public interface JolieTypesListener extends ParseTreeListener {
	/**
	 * Enter a parse tree produced by {@link JolieTypesParser#types}.
	 * @param ctx the parse tree
	 */
	void enterTypes(JolieTypesParser.TypesContext ctx);
	/**
	 * Exit a parse tree produced by {@link JolieTypesParser#types}.
	 * @param ctx the parse tree
	 */
	void exitTypes(JolieTypesParser.TypesContext ctx);
	/**
